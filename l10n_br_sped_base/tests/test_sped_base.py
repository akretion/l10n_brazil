...
class TestSpedBase(SavepointCase, FakeModelLoader):
    ...
    def test_register_tree_view(self):
        arch = self.env["l10n_br_sped.fake.i010"].fields_view_get(view_type="tree")["arch"]
    ...
    def test_register_form_view(self):
        arch = self.env["l10n_br_sped.fake.i010"].fields_view_get(view_type="form")["arch"]
        self.assertIn(  # link to declaration
            '<field name="declaration_id"',
            arch,
        )
    ...
    def test_declaration_form_view(self):
        arch = self.env["l10n_br_sped.fake.0000"].fields_view_get(view_type="form")["arch"]
