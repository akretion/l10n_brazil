...
class AccountMoveLine(models.Model):
    ...
    def create(self, vals_list):
        ...
        # because later inside _get_fields_onchange_subtotal_model, we have
        # an empty self recordset while we need to filter which lines
    ...
    def _get_fields_onchange_subtotal_model(
        ...
        if self.is_stock_only or (
            ...
            and hasattr(type(self), "_create_vals_line__counter")
