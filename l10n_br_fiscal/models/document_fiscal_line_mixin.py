...
class FiscalDocumentLineMixin(models.AbstractModel):
    ...
    discount_value = fields.Monetary(string="Discount Value", default=0.00)
    ...
    amount_tax_not_included = fields.Monetary(
        string="Amount Tax not Included", default=0.00
    )

    amount_tax_withholding = fields.Monetary(
        string="Amount Tax Withholding", default=0.00
    )
    ...
    partner_order_line = fields.Char(
        string="Partner Order Line (nItemPed)", size=6
    )
    ...
    issqn_percent = fields.Float(string="ISSQN %", default=0.00)

    issqn_reduction = fields.Float(string="ISSQN % Reduction", default=0.00)

    issqn_value = fields.Monetary(string="ISSQN Value", default=0.00)
    ...
    issqn_wh_base = fields.Monetary(string="ISSQN RET Base", default=0.00)

    issqn_wh_percent = fields.Float(string="ISSQN RET %", default=0.00)

    issqn_wh_reduction = fields.Float(
        string="ISSQN RET % Reduction", default=0.00
    )

    issqn_wh_value = fields.Monetary(string="ISSQN RET Value", default=0.00)
    ...
    icms_base = fields.Monetary(string="ICMS Base", default=0.00)

    icms_percent = fields.Float(string="ICMS %", default=0.00)

    icms_reduction = fields.Float(string="ICMS % Reduction", default=0.00)

    icms_value = fields.Monetary(string="ICMS Value", default=0.00)
    ...
    icms_relief_value = fields.Monetary(
        string="ICMS Relief Value", default=0.00
    )
    ...
    icmsst_mva_percent = fields.Float(string="ICMS ST MVA %", default=0.00)

    # pRedBCST - Percentual da Redução de BC do ICMS ST
    icmsst_reduction = fields.Float(string="ICMS ST % Reduction", default=0.00)

    # vBCST - Valor da BC do ICMS ST
    icmsst_base = fields.Monetary(string="ICMS ST Base", default=0.00)

    # pICMSST - Alíquota do imposto do ICMS ST
    icmsst_percent = fields.Float(string="ICMS ST %", default=0.00)

    # vICMSST - Valor do ICMS ST
    icmsst_value = fields.Monetary(string="ICMS ST Value", default=0.00)

    icmsst_wh_base = fields.Monetary(string="ICMS ST WH Base", default=0.00)

    icmsst_wh_value = fields.Monetary(string="ICMS ST WH Value", default=0.00)
    ...
    icmssn_base = fields.Monetary(string="ICMS SN Base", default=0.00)

    icmssn_reduction = fields.Monetary(
        string="ICMS SN Reduction", default=0.00
    )

    icmssn_percent = fields.Float(string="ICMS SN %", default=0.00)

    icmssn_credit_value = fields.Monetary(
        string="ICMS SN Credit", default=0.00
    )
    ...
    cofins_wh_base = fields.Monetary(string="COFINS RET Base", default=0.00)

    cofins_wh_percent = fields.Float(string="COFINS RET %", default=0.00)

    cofins_wh_reduction = fields.Float(
        string="COFINS RET % Reduction", default=0.00
    )

    cofins_wh_value = fields.Monetary(string="COFINS RET Value", default=0.00)
    ...
    pis_wh_base = fields.Monetary(string="PIS RET Base", default=0.00)

    pis_wh_percent = fields.Float(string="PIS RET %", default=0.00)

    pis_wh_reduction = fields.Float(string="PIS RET % Reduction", default=0.00)

    pis_wh_value = fields.Monetary(string="PIS RET Value", default=0.00)
    ...
    csll_base = fields.Monetary(string="CSLL Base", default=0.00)

    csll_percent = fields.Float(string="CSLL %", default=0.00)

    csll_reduction = fields.Float(string="CSLL % Reduction", default=0.00)

    csll_value = fields.Monetary(string="CSLL Value", default=0.00)
    ...
    csll_wh_base = fields.Monetary(string="CSLL RET Base", default=0.00)

    csll_wh_percent = fields.Float(string="CSLL RET %", default=0.00)

    csll_wh_reduction = fields.Float(
        string="CSLL RET % Reduction", default=0.00
    )

    csll_wh_value = fields.Monetary(string="CSLL RET Value", default=0.00)
    ...
    irpj_base = fields.Monetary(string="IRPJ Base", default=0.00)

    irpj_percent = fields.Float(string="IRPJ %", default=0.00)

    irpj_reduction = fields.Float(string="IRPJ % Reduction", default=0.00)

    irpj_value = fields.Monetary(string="IRPJ Value", default=0.00)
    ...
    irpj_wh_base = fields.Monetary(string="IRPJ RET Base", default=0.00)

    irpj_wh_percent = fields.Float(string="IRPJ RET %", default=0.00)

    irpj_wh_reduction = fields.Float(
        string="IRPJ RET % Reduction", default=0.00
    )

    irpj_wh_value = fields.Monetary(string="IRPJ RET Value", default=0.00)
    ...
    inss_base = fields.Monetary(string="INSS Base", default=0.00)

    inss_percent = fields.Float(string="INSS %", default=0.00)

    inss_reduction = fields.Float(string="INSS % Reduction", default=0.00)

    inss_value = fields.Monetary(string="INSS Value", default=0.00)
    ...
    inss_wh_base = fields.Monetary(string="INSS RET Base", default=0.00)

    inss_wh_percent = fields.Float(string="INSS RET %", default=0.00)

    inss_wh_reduction = fields.Float(
        string="INSS RET % Reduction", default=0.00
    )

    inss_wh_value = fields.Monetary(string="INSS RET Value", default=0.00)

    simple_value = fields.Monetary(
        string="National Simple Taxes", default=0.00
    )

    simple_without_icms_value = fields.Monetary(
        string="National Simple Taxes without ICMS", default=0.00
    )
