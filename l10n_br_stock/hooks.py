...
def set_stock_warehouse_external_ids(env, company_external_id):
    ...
    data_list = [
        ...
        {
            "xml_id": "l10n_br_stock.wh_{}_output_location".format(
                external_id
            ),
            "record": warehouse.wh_pack_stock_loc_id,
            "noupdate": True,
        ...
        {
            "xml_id": "l10n_br_stock.wh_{}_picking_type_in".format(
                external_id
            ),
        ...
        {
            "xml_id": "l10n_br_stock.wh_{}_picking_type_internal".format(
                external_id
            ),
        ...
        {
            "xml_id": "l10n_br_stock.wh_{}_pick_type_internal".format(
                external_id
            ),
        ...
        {
            "xml_id": "l10n_br_stock.wh_{}_pack_type_internal".format(
                external_id
            ),
        ...
        {
            "xml_id": "l10n_br_stock.wh_{}_picking_type_out".format(
                external_id
            ),
