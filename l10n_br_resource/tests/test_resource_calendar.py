...
class TestResourceCalendar(test_common.SingleTransactionCase):
        ...
        self.calendar_id_sp = self.resource_calendar.create(
            {
                ...
                "l10n_br_city_id": self.env.ref(
                    "l10n_br_base.city_3500105"
                ).id,
            }
        )
    ...
    def test_00_add_leave_nacional(self):
        ...
        self.assertEqual(
            self.leave_nacional_02.calendar_id, self.nacional_calendar_id
        )
    ...
    def test_01_add_leave_estadual(self):
        ...
        self.assertEqual(
            self.leave_estadual_02.calendar_id, self.estadual_calendar_id
        )
    ...
    def test_16_proximo_dia_util_bancario(self):
        ...
        prox_dia_ultil = self.nacional_calendar_id.proximo_dia_util_bancario(
            data
        )
        self.assertEqual(
    ...
    def test_17_holiday_import(self):
        ...
        data_eh_feriado = self.nacional_calendar_id.data_eh_feriado_bancario(
            data
        )
        self.assertTrue(data_eh_feriado)
